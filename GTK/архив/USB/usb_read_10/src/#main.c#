...
/*
 * main.c
 * Copyright (C) 2017 admin <admin@impulse-m>
 *
 * usb is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * usb is distributed in the hope that it will be useful, but
...
#define VENDOR_ID 0x0477
#define PRODUCT_ID 0x5620
